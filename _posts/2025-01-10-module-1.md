...
<div style="display: flex; gap: 20px; justify-content: center; flex-wrap: wrap;">
  ...
  <a href="https://news.mit.edu/2023/explained-generative-ai-1109" target="_blank" style="flex: 0 0 45%;">
    <img src="{{ '/assets/images/mit_news_image.png' | relative_url }}" alt="MIT GenAI"
         style="width: 92%; height: auto; object-fit: cover; border-radius: 8px;" />
  </a>

  <a href="https://blogs.oracle.com/fusioninsider/post/understand-the-differences-between-ai-genai-and-ml" target="_blank" style="flex: 0 0 45%;">
