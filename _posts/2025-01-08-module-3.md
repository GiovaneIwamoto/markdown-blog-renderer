...
<div style="display: flex; gap: 20px; justify-content: center; flex-wrap: wrap;">
  <img src="/assets/images/langchain_indexing.png | relative_url" alt="Langchain Indexing" style="max-width: 100%; width: 45%; height: auto; border-radius: 8px;" />
  <img src="/assets/images/langchain_retrieval.png | relative_url" alt="Langchain Retrieval" style="max-width: 100%; width: 45%; height: auto; border-radius: 8px;" />
</div>
