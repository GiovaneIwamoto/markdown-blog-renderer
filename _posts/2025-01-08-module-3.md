...
This approach produces chunks that are size-bounded yet try to respect natural text boundaries. There are two key aspects you can configure:

How the text is split: e.g. by characters, by words, by sentences, or by specific delimiters (like newline, paragraph break, etc.).

How the chunk size is measured: e.g. by number of characters, by number of tokens, or even by semantic units.
...
<div style="display: flex; align-items: flex-start; gap: 20px;">
  ...
  <div style="flex: 1;">
    <p>
      <em>
        For more information on the different types of text splitters and how to choose the right one for your use case, check out the official documentation at this link.
      </em>
    </p>
  </div>
