...
- Upon confirmation, the chatbot must generate a complete structured output that should include:
...
*To ensure a robust and interactive chatbot experience, your implementation must include the following core components:*
