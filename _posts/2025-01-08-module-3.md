...
*Whenever you change embedding models or modify your index settings, always double-check dimensional compatibility. It's a small step, but critical for system integrity. Watch the videos below for a quick recap of all the concepts we've covered so far.*
...
<div style="display: flex; gap: 20px; justify-content: center; flex-wrap: nowrap;">
  ...
  <iframe style="width: calc(50% - 10px); aspect-ratio: 16 / 9; border: none;" 
          src="https://www.youtube.com/embed/h0D7QOs4dKU" 
          title="YouTube video player" 
          allowfullscreen>
  </iframe>
