...
<div style="display: flex; gap: 20px; justify-content: center; flex-wrap: nowrap;">
  <a href="https://medium.com/data-professor/beginners-guide-to-openai-api-a0420bc58ee5" target="_blank" style="flex: 1 1 28%; box-sizing: border-box; height: 300px; overflow: hidden;">
    <img src="{{ '/assets/images/open_ai_guide.png' | relative_url }}" alt="OpenAI Guide"
         style="width: 100%; height: 100%; object-fit: cover; object-position: top; border-radius: 8px;" />
  </a>

  <a href="https://api-docs.deepseek.com" target="_blank" style="flex: 1 1 28%; box-sizing: border-box; height: 300px; overflow: hidden;">
    <img src="{{ '/assets/images/deepseek_openai.png' | relative_url }}" alt="DeepSeek OpenAI"
         style="width: 100%; height: 100%; object-fit: cover; object-position: top; border-radius: 8px;" />
  </a>
  
  <a href="https://docs.anthropic.com/en/api/openai-sdk" target="_blank" style="flex: 1 1 28%; box-sizing: border-box; height: 300px; overflow: hidden;">
...
> *And no, you definitely shouldn’t be asking the model to hunt down Windows license keys or those secret API keys that interns accidentally push to GitHub... xd*
>
